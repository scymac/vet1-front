...
export default function IconButton(props: Props) {
      ...
      case 'add':
        return (
          <AddIcon
            ...
            style={{
              transform: `scale(${props.scale === undefined ? 1 : props.scale})`
            }}
          />
        )
      case 'admin':
  ...
  const getIconFrameClass2 = () => {
    if (props.disabled && props.disableEffects)
      return classes.iconButtonDisabledNoEffects
    if (props.disabled) return classes.iconButtonDisabled
    if (props.selected && props.disableEffects)
      return classes.iconButtonSelectedNoEffects
