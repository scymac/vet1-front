...
export default function FormDropdown(props: Props) {
  const customStyle = {
    control: (provided: any, state: any) => ({
      ...
      marginLeft: '5px',
      fontSize:
        props.optionsFontSize === undefined ? 12 : props.optionsFontSize,
        ...
        >
          <Typography
            style={{
              fontWeight: 600,
              fontSize:
                props.titleFontSize === undefined ? 14 : props.titleFontSize
            }}
          >
            {props.title}
          </Typography>
          ...
          >
            ...
            >
              <Select
                ...
                maxMenuHeight={
                  props.maxMenuHeight === undefined ? 200 : props.maxMenuHeight
                }
              />
            </Box>
          </Box>
