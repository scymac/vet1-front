...
export const AlarmList = [
  ...
  // Note "1.00" is just an alarm flag that resets automatically when the PLC exchanges a message with the Server, while "1.01" must be quit manualy
  {
    ...
    causes:
      'Anlage ausgeschaltet, Ethernetkabel ausgesteckt, Wackelkontakt, Kabelbruch, defekte Ethernetkarte'
  },
  {
    code: '1.11',
    severity: 'error',
  ...
  // Group 2 - PLC
  {
    ...
    target: '+U3-25K4 IPC',
    description:
      'Die vom Multimeter abgelesenen Werte konnten nicht in die Datenbank übertragen werden',
    causes:
      'SPS⟷Server Verbindungsproblem, SPS-Software-Fehler, Server-Software-Fehler'
  },
  ...
  // Group 4 - Sensors
  {
    ...
    target: '+U1-123X1',
    description:
      'Das Lasersensorsignal liegt ausserhalb des normalen Betriebsbereichs',
  ...
  // Group 5 - Mechanic/Pneumatic
  {
    ...
    causes:
      'Kein/unzureichender Luftdruck, Luftleck, Wackelkontakt, Drahtbruch, Zylinder mechanisch blockiert, defektes Ventil, defektes SPS-Modul, Folgealarm aufgrund eines Problems mit dem Positionssensor'
  },
  {
    code: '5.02',
    severity: 'error',
  ...
  },
  {
    ...
    causes:
      'Multimeter ausgeschaltet, Ethernetkabel ausgesteckt, Kabelbruch, Wackelkontakt'
  },
  {
    code: '6.03',
    severity: 'error',
